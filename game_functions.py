...
def check_bullet_alien_collision(ai_settings, screen, stats, sb,
    ...
    # Check for bullets that hit the aliens
    # and get rid of the bullet and alien.
    ...
    if len(aliens) == 0:
        ...
        # Start a new level if entire fleet is destroyed.
        bullets.empty()
...
def fire_bullet(ai_settings, screen, ship, bullets):
    ...
    # and limit the number of bullets allowed per shot outburst
...
def check_aliens_bottom(ai_settings, stats, screen, sb, ship,
                        aliens, bullets):
